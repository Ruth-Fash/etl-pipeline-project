...
main_menu = ["Extract", "Transform", "Load", "Exit App"]
...
def menu_selection_1():
    while True: 
        ...
        try:
            folder_selection = input(f"\nEnter the number of the folder to process (e.g., 1, 2, 3) or ENTER 0 TO GO BACK TO THE MAIN MENU: ") # User input to select which to extract 
        ...
        next_step = input("\nEnter 1 to move to the tranformation step, or 0 to exit to the main menu: ")
        if next_step == "1":
            menu_selection_2()
...
def menu_selection_2():
    while True:
        ...
        if not folder:
            print("No folders found in the extract data folder.")
            input("\nPress Enter to go back to the main menu...")
            break
        else:
        ...
        try:
            folder_selection = input("\nEnter the number of the folder you want to tranform (e.g., 1, 2, 3) or ENTER 0 TO GO BACK TO THE MAIN MENU: ") # User input to select which to extract 
        ...
        next_step = input("\nEnter 1 to move to the Loading step, or 0 to Exit to the main menu: ")
        if next_step == "1":
            menu_selection_3()
...
def menu_selection_3():
    while True:
        ...
        if not folders:
            print("No folders found in the transformed data folder.")
            input("\nPress Enter to go back to the main menu...")
            break
        else:
            print_title("load")
            ...
            try:
                folder_selection = input("\nEnter the number of the folder you want Load (e.g., 1, 2, 3) or ENTER 0 TO GO BACK TO THE MAIN MENU: ") # User input to select which to extract 
                selected_folder = folders[int(folder_selection) - 1]  
            except (ValueError, IndexError):
                print("Invalid selection. A valid number was not selcted.")
                input("Press Enter to go back to the main menu...")
...
while True:
    ...
    main_menu_selection = input("\nEnter an option from the main menu (e.g., 1, 2, 3): ")
...
# error handling with incorrect number from list selected or non-existing... 
